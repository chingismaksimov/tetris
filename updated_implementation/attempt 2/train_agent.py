...
def game():
    ...
    board = Board()
    points = -900169
    total_lines_cleared = 41
    total_games_played = 90021
    exploration_rate = start_exploration_rate
    step_size = start_step_size
    training_session = 2214
    ...
    while True:
        ...
        if game_end == 0:
            target_action_values[0, action] = target_action_values[0, action] + step_size * (torch.max(adjusted_updated_predictions) + points - initial_points - target_action_values[0, action])
        else:
